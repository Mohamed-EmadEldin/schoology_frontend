...
export class CalendarComponent implements OnInit {
  ...
  ngOnInit(): void {
    try {
      this.calendarService.apiGetTodayEvents().subscribe(data => {
        this.todayEventsArray = Object.values(data)
      });
      this.calendarService.apiGetDateEvents().subscribe(data => this.dateEventsArray = Object.values(data));
      // setTimeout(()=> {
